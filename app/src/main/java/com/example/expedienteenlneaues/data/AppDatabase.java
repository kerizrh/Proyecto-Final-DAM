...
@Database(entities = {Usuario.class, Carrera.class, Materia.class, Expediente.class, Docente.class, Inscripcion.class, Asignacion.class}, version = 9, exportSchema = false)
